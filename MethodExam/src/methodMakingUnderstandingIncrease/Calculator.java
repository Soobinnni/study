	...
	public static void main(String[] args) {
		...
		do { // 숫자1 입력
			...
			case '+':
				...
				// 두 수를 계산한 값을 호출한다.			
				programAnswer = sum(num1, num2);
				
				// 결과를 알려준다.
				System.out.println("식 : " + num1 + op.charAt(0) + num2 + " = "+programAnswer);
			...
			case '-':
				...
				num2 = input.nextDouble();
				// 두 수의 차를 구한다.
				programAnswer = subtract(num1, num2);
				// 결과를 알려준다.
				System.out.println("식 : " + num1 + op.charAt(0) + num2 + " = "+programAnswer);
			...
			case '*':
				...
				num2 = input.nextDouble();
				// 두 수의 곱을 구한다.
				programAnswer = multiply(num1, num2);
				// 결과를 알려준다.
				System.out.println("식 : " + num1 + op.charAt(0) + num2 + " = "+programAnswer);
			...
			case '/':
				...
				do {
					...
					if (num2 == 0) {
						...
						// 두 수의 나눔을 구한다.
						programAnswer = divide(num1, num2);
						// 결과를 알려준다.
						System.out.println("식 : " + num1 + op.charAt(0) + num2 + " = "+programAnswer);
