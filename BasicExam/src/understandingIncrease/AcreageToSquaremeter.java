...
public class AcreageToSquaremeter {
	...
	public static void main(String[] args) {
		...
		// 변수 설정
		int acreage; // 평 변수
		final double CONVERSION_VALUE; // 평에서 제곱미터로 변환할 때 필요한 상수 값
		...
		// acreage(평)은 0보다 큰 값일 때 T-(계산식을 수행하고 출력값 도출), F-(정정요구를 출력)
		if (acreage > 0) {
			// 입력받은 '평'을 제곱미터로 환산함
			CONVERSION_VALUE = 3.3058; // 1평=3.3058
			...
			System.out.println("입력한 평의 값이 음수로 입력되어 있습니다. 양수로 입력해주세요.");
		}
