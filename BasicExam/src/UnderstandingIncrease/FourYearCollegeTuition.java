...
public class FourYearCollegeTuition {
	...
	public static void main(String[] args) {
		...
		//계산식
		//각 해의 등록금 계산. 매년 4.5%씩 복리로 계산.(복리계산-원금, 원금+원금*이율, 원금+((원금*이율)*이율)…).	
		sophomoreTuition=(double)freshmanTuition+(freshmanTuition*INTEREST_RATE); //2년째 해의 등록금=원금+(첫째해*이율)
		thirdGraderTuition=(double)freshmanTuition+(sophomoreTuition*INTEREST_RATE); //3년째 해의 등록금=원금+(둘째해*이율)
		fourthGraderTuition=(double)freshmanTuition+(thirdGraderTuition*INTEREST_RATE); //4년째 해의 등록금=원금+(셋째해*이율)
