...
public class StuedentVO {
	private int no;// 일련번호/PK
	private String sd_num;// 학번
	private String sd_name;// 이름
	private String sd_id;// 아이디
	private String sd_passwd;// 패스워드
	...
	private String sd_date;// 등록일자

	public StuedentVO() {
		super();
	}

	public StuedentVO(int no, String sd_num, String sd_name, String sd_id, String sd_passwd, String s_num,
	...
	public String toString() {
		return "StuedentVO [getNo()=" + getNo() + ", getSd_num()=" + getSd_num() + ", getSd_name()=" + getSd_name()
				+ ", getSd_id()=" + getSd_id() + ", getSd_passwd()=" + getSd_passwd() + ", getS_num()=" + getS_num()
				+ ", getSd_birthday()=" + getSd_birthday() + ", getSd_phone()=" + getSd_phone() + ", getSd_address()="
				+ getSd_address() + ", getSd_email()=" + getSd_email() + ", getSd_date()=" + getSd_date() + "]";
	}
}
